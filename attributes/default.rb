...
default[:corbel][:iam][:jvmArguments] = "-Xms=128m -Xmx=256m"
...
default[:corbel][:resources][:jvmArguments] = "-Xms=128m -Xmx=512m"
...
default[:corbel][:webfs][:jvmArguments] = "-Xms=64m -Xmx=256m"
...
default[:corbel][:evci][:jvmArguments] = "-Xms=128m -Xmx=512m"
...
default[:corbel][:oauth][:jvmArguments] = "-Xms=128m -Xmx=256m"
